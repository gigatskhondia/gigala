...
At present, Gigala software consists of topology optimization module, and offshore pipelay dynamics module (now separated in [Ocean Intella](https://github.com/gigatskhondia/ocean_intella) software). It uses artificial intelligence to assist an engineer in her design. You can use it as research or engineering analysis tool to design different mechanical components and elements.
