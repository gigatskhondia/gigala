...
For current benchmarks see [(preprint) Pseudo 3D topology optimisation with reinforcement learning](https://www.researchgate.net/publication/393164291_Pseudo_3D_topology_optimisation_with_reinforcement_learning) and [(preprint) Practical topology optimization with deep reinforcement learning](https://www.researchgate.net/publication/398406554_Practical_topology_optimization_with_deep_reinforcement_learning).
