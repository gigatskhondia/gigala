...
MAX_FULL_EVALS=${GEN_RL_MAX_FULL_EVALS:-2048}
MAX_RL_FULL_EVALS=${GEN_RL_MAX_RL_FULL_EVALS:-512}
RL_TOTAL_TIMESTEPS=${GEN_RL_RL_TOTAL_TIMESTEPS:-50000}
...
echo "Defaults: RL enabled, rl_device=${RL_DEVICE}, rl_total_timesteps=${RL_TOTAL_TIMESTEPS}, max_full_evals=${MAX_FULL_EVALS}, max_rl_full_evals=${MAX_RL_FULL_EVALS}"
