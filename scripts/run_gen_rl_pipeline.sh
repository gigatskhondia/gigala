...
RESOLUTION=${GEN_RL_RESOLUTION:-32}
VOLUME_TARGET=${GEN_RL_VOLUME_TARGET:-0.55}
SOLVER_BACKEND=${GEN_RL_SOLVER_BACKEND:-scipy}
RUNTIME_BUDGET_HOURS=${GEN_RL_RUNTIME_BUDGET_HOURS:-0.01}
COARSE_POPULATION=${GEN_RL_COARSE_POPULATION:-10}
COARSE_GENERATIONS=${GEN_RL_COARSE_GENERATIONS:-3}
COARSE_ELITE_COUNT=${GEN_RL_COARSE_ELITE_COUNT:-4}
STAGE32_TOP_K=${GEN_RL_STAGE32_TOP_K:-4}
STAGE64_TOP_K=${GEN_RL_STAGE64_TOP_K:-2}
LOCAL_SEARCH_STEPS32=${GEN_RL_LOCAL_SEARCH_STEPS32:-3}
LOCAL_SEARCH_STEPS64=${GEN_RL_LOCAL_SEARCH_STEPS64:-3}
RL_TOTAL_TIMESTEPS=${GEN_RL_RL_TOTAL_TIMESTEPS:-10000}
MAX_FULL_EVALS=${GEN_RL_MAX_FULL_EVALS:-80}
MAX_RL_FULL_EVALS=${GEN_RL_MAX_RL_FULL_EVALS:-500}
RANDOM_SEED=${GEN_RL_RANDOM_SEED:-42}
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
OUTPUT_DIR=${GEN_RL_OUTPUT_DIR:-/tmp/gen_rl_cli_${RESOLUTION}_${TIMESTAMP}}
RL_FLAG=""
...
echo "Running gen_rl pipeline from ${REPO_ROOT}"
