...
def train(params):
    ...
    exploration_state_noise = np.array([params['state_noise']])
    ...
    agent = HAC(k_level, H, state_dim, action_dim, render, threshold, 
                action_bounds, action_offset, state_bounds, state_offset, lr, env.optimizer, env.layer_dim,
                env.n_layers)
...
def objective(trial):
    ...
    params = {
            ...
            #    'random_seed': trial.suggest_int("random_seed", 1, 5),
              ...
              'state_noise': trial.suggest_loguniform('state_noise', 0.01, 1),
