...
class TrainPipeline():
    def __init__(self, init_model=None):
        ...
        self.board_width, self.board_height =real_dim(self.board_width, self.board_height)
        ...
        for state, mcts_porb, winner in play_data:
            for i in [1, 2, 3, 4]:
                ...
                equi_mcts_prob = np.rot90(np.flipud(
                    mcts_porb.reshape(self.board_width,self.board_height)), i)
    ...
    def run(self):
        ...
        try:
            for i in range(self.game_batch_num):
                # print(self.play_batch_size)
                self.collect_selfplay_data(self.play_batch_size)
                print("batch i:{}, episode_len:{}".format(
                        i+1, self.episode_len))
                # print("hi",len(self.data_buffer),self.batch_size)
